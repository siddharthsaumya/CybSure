  ...
  return (
    <>
      <TextField
        ...
        sx={{ display: 'block', margin: 'auto', marginBottom: '20px', width: '100%' }} // Styled TextField
      />
              ...
              <TableCell>
                ...
                >
                  ...
                  <DialogContent>
                    ...
                    <Typography gutterBottom>Documents: {item.documents.map(docitem =>(<><a href={docitem}>Documet</a>&nbsp;</>))}
